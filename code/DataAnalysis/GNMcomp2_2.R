...
Tablelow0.51 <- SensiAnalysis(-2.944,0.51) 
Tablemedian0.51 <- SensiAnalysis(-2.197,0.51) 
Tablehigh0.51 <- SensiAnalysis( -1.386,0.51) 

Table1 <- integrate(Tablelow0.51, Tablemedian0.51, Tablehigh0.51)
xtable(Table1,digits = 3)

# Moderate Measurement Error

Tablelow0.56 <- SensiAnalysis(-2.944,0.56) 
Tablemedian0.56 <- SensiAnalysis(-2.197,0.56) 
Tablehigh0.56 <- SensiAnalysis( -1.386,0.56) 

Table2 <- integrate(Tablelow0.56, Tablemedian0.56, Tablehigh0.56)
xtable(Table2,digits = 3)

# Higher Measurement Error

Tablelow0.61 <- SensiAnalysis(-2.944,0.61) 
Tablemedian0.61 <- SensiAnalysis(-2.197,0.61) 
Tablehigh0.61 <- SensiAnalysis( -1.386,0.61) 

Table3 <- integrate(Tablelow0.61, Tablemedian0.61, Tablehigh0.61)
